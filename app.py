...
st.sidebar.success("✅ All 5 bonus features included")
st.sidebar.markdown("**Bonus Features:**")
st.sidebar.markdown("- ✅ Sankey Diagram")
st.sidebar.markdown("- ✅ Animated Charts")
st.sidebar.markdown("- ✅ PR Curve")
st.sidebar.markdown("- ✅ Dark/Light Toggle")
